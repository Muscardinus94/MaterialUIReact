...
import technologyAniumation from "../animations/technologyAnimation/data.json";
...
export default function Revolution(props) {
  ...
  const defaultOptions = {
    loop: true,
    autoplay: true,
    animationData: technologyAniumation,
    rendererSettings: {
  ...
  return (
    <Grid container direction="column">
      ...
      <Grid
        ...
        direction={matchesMD ? "column" : "row"}
        className={classes.rowContainer}
        style={{ backgroundColor: "#39b948", height: "90em" }}
      >
        <Grid
          item
          container
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img
            src={design}
            alt="paintbrush leaking stroke of paint"
            style={{ maxWidth: 1000 }}
            width="100%"
          />
        </Grid>
